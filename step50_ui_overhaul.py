...
files = {
    # --- 1. GLOBAL LAYOUT (Fix Favicon & Base Colors) ---
    "app/layout.tsx": """
import './globals.css';
...
export const metadata: Metadata = {
  title: 'Babji Bank - Next Gen Banking',
...
""",
    ...
    # --- 2. CORE CARD COMPONENT (Auto-Fix Dark Mode Text) ---
...
""",
    ...
    # --- 3. NEW CUSTOMER DASHBOARD (Fintech Style) ---
                ...
                <div className="relative z-10 p-6 flex flex-col justify-between h-full">
                    ...
                    <div className="flex justify-between items-end mt-4">
                        <div>
                            ...
                            <button onClick={copyToClipboard} className="font-mono text-sm tracking-widest flex items-center gap-2 hover:text-blue-300 transition">
...
def ui_overhaul():
    print("🎨 Applying Fintech UI Overhaul & Dark Mode Fixes...")
