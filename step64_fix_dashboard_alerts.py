...
files = {
    # --- 1. REWRITE ADMIN DASHBOARD (Safe Links & Clean UI) ---
...
""",
    ...
    # --- 2. FIX SETTINGS API (Allow GET for Sidebar Logo) ---
...
def fix_dashboard_alerts():
    for path, content in files.items():
        os.makedirs(os.path.dirname(path), exist_ok=True)
        with open(path, "w", encoding="utf-8") as f:
            f.write(content.strip())
    print("✅ Fixed Dashboard Alert Loop & Quick Links!")

if __name__ == "__main__":
    fix_dashboard_alerts()